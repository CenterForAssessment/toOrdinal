...
This is 1.2 release of the **toOrdinal** package.  This release includes support for Dutch thanks to @huisman:

```{r}
toOrdinal(1, language="Dutch")
```
