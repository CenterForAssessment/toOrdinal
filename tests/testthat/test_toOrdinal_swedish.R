...
test_that("toOrdinal correctly processes integers 0-40 in Swedish", {
  first_40 <- c("0:e", "1:a", "2:a", "3:e", "4:e", "5:e", "6:e", "7:e", "8:e", "9:e",
  ...
  using_toOrdinal <- sapply(c(0:40), "toOrdinal", language="swedish")
